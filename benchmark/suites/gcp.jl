...
for sz in [(15, 20, 25), (30, 40, 50)], r in 1:2
    ...
    SUITE["least-squares-size(X)=$sz, rank(X)=$r"] = @benchmarkable gcp($X, $r, LeastSquaresLoss()) 
end
...
for sz in [(15, 20, 25), (30, 40, 50)], r in 1:2
    ...
    SUITE["bernoulliOdds-size(X)=$sz, rank(X)=$r"] = @benchmarkable gcp($X, $r, BernoulliOddsLoss())
end
